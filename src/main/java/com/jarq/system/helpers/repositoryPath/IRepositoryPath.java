...
public interface IRepositoryPath {
     ...
     * + "textId" (this directory contains filepath/files with the same id (stores previous versions of the filepath))
     * + "text modificationDate" (it's concrete text filepath)
     */
    ...
    // "src/main/resources/repositories/1/2/1/20180501102159.repo" (path to filepath with filepath)
    String filepath(IText text);
